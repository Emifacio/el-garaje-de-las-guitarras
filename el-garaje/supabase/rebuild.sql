...
-- **WARNING**: This script DROPS your existing tables. Use with caution.
-- Run this in the Supabase SQL Editor

-- 0. Drop existing tables if they exist to start fresh
...
CREATE TABLE public.products (
    ...
    sold_date TIMESTAMPTZ DEFAULT NULL,
    badge TEXT,
    brand TEXT,
    year INTEGER,
...
-- Drop existing storage policies if rebuilding
...
-- 6. Insert Seed Data - Categories (Including Efectos)
